...
/**
 * H3K | Navi File Manager V2.5.3
 * @author NatusVincere
 * @github https://github.com/prasathmani/tinyfilemanager
 * @link https://natusvincere-id.web.app/
 */
...
//Application Title
define('APP_TITLE', 'Natusvincere File Manager');
...
// Generate secure password hash - https://natusvincere-id.web.app/
$auth_users = array(
    'natusvincere' => '$2y$10$LEGI3xclUuklF8dxv.ZnHOmJYhLH1Gb2rSVENMO0GBQMYGbTuk8HG', //admin@123
    'natusvincere' => '$2y$10$R9WoKh7v7R3aObl7qH6eiOUvDvP0Rot183G/3hDlnpiG4wEM/ZaVy' //12345
);
...
// sample config - https://natusvincere-id.web.app/
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                                ...
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="mb-3">
                                        ...
                                        <div class="text-center">
                                            <h1 class="card-title">Natusvincere File Manager</h1>
                                        </div>
                                    </div>
                                    <hr />
                                    <div class="mb-3">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://natusvincere-id.web.app/" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">NatusVincere</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://github.com/prasathmani/tinyfilemanager" target="_blank" class="app-v-title"> Natus Vincere File Manager <?php echo VERSION; ?></a></h3></p>
                        <p>Author: Natus Vincere</p>
                        <p>Mail Us: <a href="https://natusvincere-id.web.app">mrch.seo@gmail.com</a> </p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://natusvincere-id.web.app/" target="_blank" class="float-right text-muted">Navi File Manager <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://natusvincere-id.web.app/" target="_blank" class="float-right text-muted">Navi File Manager <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'Navi File Manager<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
<head>
    ...
    <meta name="description" content="The Best File Manager in PHP Created Natus Vincere | Manage Your Files Efficiently & Easily.">
    <meta name="author" content="NatusVincere">
    <meta name="robots" content="noindex, nofollow">
    <meta name="googlebot" content="noindex">
    <link rel="icon" type="image/png" href="https://natusvincere-id.web.app/panda.svg"/> 
    ...
    <style>
        ...
        .fm-login-page .brand{ width:180px;overflow:hidden;margin:0 auto;position:relative;z-index:1}
        .fm-login-page .brand img{ width:100%}
        .fm-login-page .card-wrapper{ width:360px;margin-top:10%;margin-left:auto;margin-right:auto;}
        .fm-login-page .card{ border-color:#e9ecef;box-shadow:0 2px 8px #e9ecef}
        ...
        body.fm-login-page.theme-dark {background-color: #000;}
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'Navi File Manager';      $tr['en']['AppTitle']           = 'Navi File Manager';
